...
public class ImovelAluguel extends Imovel {
    ...
    public ImovelAluguel(int prazoContrato, float valorAluguel, String logradouro, String complemento, String cidade, String bairro, String estado, int numero, String cep, float area, int quartos, int suites, int vagasGaragem, int banheiros) {
